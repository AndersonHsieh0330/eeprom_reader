...
HD_PWD='C:/Users/andy1/fpgaProjects/eeprom_reader/eeprom_reader.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_design_wrapper.tcl
